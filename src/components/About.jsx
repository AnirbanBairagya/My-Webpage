    ...
    <section id="about">
      <div className="container">
        <div className="section-head">
          ...
          <h2>Grounded in fundamentals, drawn to ML.</h2>
        </div>
        <div className="about-grid">
          ...
          <div className="info-list">
            ...
            <div className="info-row">
              ...
              <span className="v">Machine Learning / Backend</span>
            </div>
            <div className="info-row">
              <span className="k">Languages</span>
              <span className="v">Python, Java, SQL</span>
            </div>
            <div className="info-row">
              <span className="k">Spoken</span>
              <span className="v">English, Hindi, Bengali</span>
            </div>
            <div className="info-row">
